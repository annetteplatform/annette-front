<template>
  <div class="full-width">
    ...
    <business-process-variable-edit-dialog :show="showVariableDialog"
...
import BusinessProcessVariableEditDialog from './BusinessProcessVariableEditDialog.vue';
    ...
    const columns = [
      {
        name: 'variableName',
        required: true,
        label: i18n.t('annette.bpm.businessProcess.field.var.variableName'),
        align: 'left',
        field: 'variableName',
        sortable: true,
      },
      {
        name: 'name',
        align: 'left',
        label: i18n.t('annette.bpm.businessProcess.field.var.name'),
        field: 'name',
        sortable: true,
      ...
      },
      {
        name: 'caption',
        align: 'left',
        label: i18n.t('annette.bpm.businessProcess.field.var.caption'),
        field: 'caption',
        sortable: true,
        classes: 'text-truncate'
      },

      {
        name: 'datatype',
        align: 'left',
        label: i18n.t('annette.bpm.businessProcess.field.var.datatype'),
        field: 'datatype',
        sortable: true,
        classes: 'text-truncate'
      },

      {
        name: 'default',
        align: 'left',
        label: i18n.t('annette.bpm.businessProcess.field.var.default'),
        field: 'default',
        sortable: true,
        classes: 'text-truncate'
      },
