...
import {Datatype, FullBusinessProcessVariable, StoreBusinessProcessVariablePayloadDto} from 'src/modules/bpm';


export default defineComponent({
  name: 'BusinessProcessVariableEditDialog',
  components: {},
  props: {
    show: {
      type: Boolean,
  ...
  setup(props, {emit}) {
    ...
    const update = () => {
      ...
      let payload: StoreBusinessProcessVariablePayloadDto = {
        businessProcessId: '',
        ...variableModel.value,
        oldVariableName
