...
import {AuthRole, AuthRoleFilter, useAuthRoleStore} from 'src/modules/authorization';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const columns = [
      {
        name: 'id',
        required: true,
        label: i18n.t('annette.authorization.authRole.field.id'),
        align: 'left',
        field: 'id',
        sortable: true,
      },
      {
        name: 'name',
        required: true,
        label: i18n.t('annette.authorization.authRole.field.name'),
        align: 'left',
        field: 'name',
        sortable: true,
      }
    ...
    const deleteEntity = useDeleteEntity(
      store,
      i18n.t('annette.authorization.authRole.deleteQuestion'),
    )
