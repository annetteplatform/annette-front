  ...
  <q-pull-to-refresh @refresh="refreshEntities">
    <div class="row items-start">
      <div class="q-pb-sm col-md-12 col-sm-12 col-xs-12">
        ...
        >
          <template v-slot:top>
            <h5 class="q-ma-none">Space Categories</h5>
            <q-space/>
            ...
            <q-btn color="primary" :disable="loading" label="Create" :to="{ name: 'cms.category', params: { action: 'create', id: 'new' } }"/>
          </template>
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="actions" :props="props" style="width: 12em">
                <q-btn flat round color="green" size="sm" icon="far fa-eye" :to="{ name: 'cms.category', params: { action: 'view', id: props.row.id } }"/>
                <q-btn flat round color="blue" size="sm" icon="far fa-edit" :to="{ name: 'cms.category', params: { action: 'edit', id: props.row.id } }"/>
    ...
    <q-dialog v-model="deleteDialog" persistent>
      <q-card>
        <q-card-section class="row items-center">
          ...
          <span class="q-ml-sm">Please confirm delete space category</span>
        </q-card-section>
...
const PAGE_SIZE = 10
const DEFAULT_INSTANCE_KEY = 'SpaceCategories'
...
export default class SpaceCategoryList extends Vue {
  @Prop(Number) page
