      ...
      <q-card class="my-card">
        <q-card-section horizontal>
          <q-form
            ...
            <div class="row">
              <space-view-multi-selector v-model="filterModel.spaces"/>
            </div>
          </q-form>
...
import SpaceViewMultiSelector from 'src/modules/cms/ui/space-view/components/SpaceViewMultiSelector.vue';

export default defineComponent({
  name: 'PageViewFilterForm',
  components: {SpaceViewMultiSelector},
  props: {
    filter: {
      type: Object as PropType<PageViewFilter>,
      required: true
    },
    emptyFilter: {
      type: Function
  ...
  setup: function (props, {emit}) {
    ...
    const filterModel: Ref<PageViewFilter> = ref({...props.filter})
