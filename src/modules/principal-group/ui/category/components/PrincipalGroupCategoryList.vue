...
export default defineComponent({
  name: 'PrincipalGroupCategoryList',
  ...
  setup(props) {
    ...
    const columns = [
      {
        name: 'id',
        required: true,
        label: i18n.t('annette.principalGroup.category.field.id'),
        align: 'left',
        field: 'id',
        sortable: true,
      },
      {
        name: 'name',
        required: true,
        label: i18n.t('annette.principalGroup.category.field.name'),
        align: 'left',
        field: 'name',
        sortable: true,
      }
    ...
    const deleteEntity = useDeleteEntity(
      store,
      i18n.t('annette.principalGroup.category.deleteQuestion'),
    )
