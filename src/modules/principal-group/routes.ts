...
export const principalGroupRoutes: RouteRecordRaw[] = [
  {
    ...
    component: () => import('src/modules/principal-group/ui/group/PrincipalGroupListPage.vue'),
    meta: {requiresAuth: true}
  },
  {
    path: 'principal-group/group/:action/:id',
    name: 'principalGroup.group',
    component: () => import('src/modules/principal-group/ui/group/PrincipalGroupPage.vue'),
  ...
  },
  {
    ...
    component: () => import('src/modules/principal-group/ui/category/PrincipalGroupCategoryListPage.vue'),
    meta: {requiresAuth: true}
  },
  {
    path: 'principal-group/category/:action/:id',
    name: 'principalGroup.category',
    component: () => import('src/modules/principal-group/ui/category/PrincipalGroupCategoryPage.vue'),
    props: (route) => ({ id: String(route.params.id),  action: String(route.params.action),}),
    meta: {requiresAuth: true}
  }
]
