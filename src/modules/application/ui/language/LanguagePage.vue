<template>
  <entity-page narrow
               :caption="$t('annette.application.language.title')"
    ...
    <template v-slot:save-toolbar >
      <div class="row">
        <q-btn v-if="action == 'edit'" outline dense
               ...
               :to="{ name: 'application.language', params: { action: 'view', id } }"/>
        <q-btn dense
               color="primary"
    ...
    <template v-slot:default>
      <div class="row q-pb-md">
        <q-input class="col-md-4 col-sm-12 col-xs-12 "
                 ...
                 ref="idRef"
                 :label="$t('annette.application.language.field.id')"/>
      </div>
      <div class="row q-pb-md">
        <q-input class="col-md-12 col-sm-12 col-xs-12 "
                 ...
                 ref="nameRef"
                 :label="$t('annette.application.language.field.name')"/>
      </div>
