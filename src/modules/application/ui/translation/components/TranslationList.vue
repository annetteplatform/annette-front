...
import {Translation, TranslationFilter} from 'src/modules/application/data/translation.model';
import {useTranslationStore} from 'src/modules/application/data/translation.store';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const columns = [
      {
        name: 'id',
        required: true,
        label: i18n.t('annette.application.translation.field.id'),
        align: 'left',
        field: 'id',
        sortable: true,
      },
      {
        name: 'name',
        required: true,
        label: i18n.t('annette.application.translation.field.name'),
        align: 'left',
        field: 'name',
        sortable: true,
      }
    ...
    const entityList = useEntityList<Translation, TranslationFilter>(
      store,
      props.instanceKey,
    )
    ...
    const deleteEntity = useDeleteEntity(
      store,
      i18n.t('annette.application.translation.deleteQuestion'),
    )
