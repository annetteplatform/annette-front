...
import {OrgItem, OrgItemFilter, useOrgItemStore} from 'src/modules/org-structure';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const columns = [
      {
        name: 'id',
        required: true,
        label: i18n.t('annette.orgStructure.orgItem.field.id'),
        align: 'left',
        field: 'id',
        sortable: true,
      },
      {
        name: 'name',
        required: true,
        label: i18n.t('annette.orgStructure.orgItem.field.name'),
        align: 'left',
        field: 'name',
        sortable: true,
      },
      {
        name: 'categoryId',
        required: true,
        label: i18n.t('annette.orgStructure.orgItem.field.categoryId'),
        align: 'left',
        field: 'categoryId',
        sortable: true,
      }
    ...
    const deleteEntity = useDeleteEntity(
      store,
      i18n.t('annette.orgStructure.organization.deleteQuestion'),
    )
