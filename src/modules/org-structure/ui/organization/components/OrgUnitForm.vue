<template>
  <div class="q-ma-md full-width ">
    ...
    <div class="q-gutter-md" v-if="entity">
      ...
      <div class="row">
        <org-category-selector :type="unitType"
...
import {AssignChiefPayloadDto, OrgItem, UnassignChiefPayloadDto, useOrgItemStore} from 'src/modules/org-structure';
import OrgItemSelector from './OrgItemSelector.vue';
import PositionViewField from './PositionViewField.vue';
...
export default defineComponent({
  ...
  components: {
    OrgCategorySelector,
    PositionViewField, OrgItemSelector
  },
  props: {
    action: {
      type: String,
