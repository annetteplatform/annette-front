  ...
  <div class="narrow-layout">
    <div class="row">
      ...
      <q-item class="q-mr-none">
        <h5 class="q-ma-none">Categories</h5>
        <q-space/>
...
export default defineComponent({
  ...
  components: {PersonCategoryList, SimpleFilterForm, MessageBox},
  setup() {

    const entityListPage = useEntityListPage('personCategory', INSTANCE_KEY)
