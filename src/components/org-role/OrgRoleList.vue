          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="actions" :props="props" style="width: 12em">
                <q-btn flat round color="green" size="sm" icon="far fa-eye" :to="`/org-structure/role/view/${props.row.id}`"/>
                <q-btn flat round color="blue" size="sm" icon="far fa-edit" :to="`/org-structure/role/edit/${props.row.id}`"/>
